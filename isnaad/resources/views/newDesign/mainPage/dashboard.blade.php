    ...
    <div class="content-body">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"> Carrier Peformance (# of days for the order to be delivered)</h4>
                        <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li><a data-action="collapse"><i class="feather icon-chevron-down"></i></a></li>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"> Carrier Peformance (# of Hours for the order to be delivered)</h4>
                        <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li><a data-action="collapse"><i class="feather icon-chevron-down"></i></a></li>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <div id="carrer_per_hours" class="center-block">
...
{{--                <div class="card">--}}
{{--                    <div class="card-header">--}}
{{--                        <h4 class="card-title">Cod For Carriers </h4>--}}
{{--                        <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>--}}
{{--                        <div class="heading-elements">--}}
{{--                            <ul class="list-inline mb-0">--}}
{{--                                <li><a data-action="collapse"><i class="feather icon-chevron-down"></i></a></li>--}}
...
{{--                    <div class="card-content collapse show">--}}
{{--                        <div class="card-body">--}}
{{--                            <div id="chart6" class="center-block">--}}
...
///chart all carieres
    ...
    var statiscForChart=   f(namesCarriers,mydat.statisticCarriers,1);

      function f(namesCarriers,carSta,flage) {
            var ar=[];
            var i=0;
            namesCarriers.map(el=>{
               ...
               if(carSta[el]==0){
                  ...
                  var num  = carSta[el]*flage;
                   var roudedString = num.toFixed(2);
        ...
        var namesCarriers=getNameCar(mydat.carreires);
        var statiscForChart=   f(namesCarriers,mydat.carrierName,1);
        ...
        var statiscForChartPerHours=   f(namesCarriers,mydat.carrierName,24);

        var options_Carrer_per_hours= {
            series: [{
                data:statiscForChartPerHours
            }],
            chart: {
                type: 'bar',
                height: 380
        ...
        var carrer_per_hours= new ApexCharts(document.querySelector("#carrer_per_hours"), options_Carrer_per_hours);
        carrer_per_hours.render();
        //carrer_per_hours
      ...
      //  chart6.render();
        ...
        var statiscForChart=   f(mydat.cityName,mydat.cityStasitsic,1);
