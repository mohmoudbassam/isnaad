                ...
                <table>
                    <tr>
                        ...
                        <td style="font-size: 1.2rem; font-weight: bold; ">
                            <span class="m-r-10" style="font-size: 1.5rem; ;font-weight: bold; ">{{$inv_num}} رقم الفاتورة :</span>
                            <br/>
                            <br/>
                            <span class="m-r-10" style="font-size: 1.3rem; ;font-weight: bold; "> تاريخ إصدار الفاتورة : {{\Carbon\Carbon::parse($end_date)->format('Y / m / d')}}</span>
                            <br/>
                ...
                <table>
                    <tr>
                        <td style="font-size: 1.2rem;  ">
                            <span style="font-size: 1.5rem; font-weight: bold; ">   Client Name : </span><span style="font-size: 1.4rem; font-weight: bold; ">   {{$store->name}} Store</span>
                            <br/>
                            <span style="font-size: 1.5rem; font-weight: bold; ">الســجل  التجــاري للــعميل :</span><span style="font-size: 1.2rem; font-weight: bold; "> {{$store->Register_number }}</span>    
                            <br/>
                            <span style="font-size: 1.5rem; font-weight: bold; ">  فترة الخدمة </span> 
                            <span style="font-size: 1.2rem; font-weight: bold;"> : من {{\Carbon\Carbon::parse($start_date)->format('Y / m / d')}}   الى  {{\Carbon\Carbon::parse($end_date)->format('Y / m / d')}}</span> 
                               <br/>

                        </td>

                        <td style="font-size: 1.5rem; ">
                            <span style="font-size: 1.5rem; font-weight: bold; "> اسم العميل : </span> <span style="font-size: 1.4rem; font-weight: bold; ">  {{$store->Name_ar}}</span>  <br/>
                            <span style="font-size: 1.5rem; font-weight: bold; ">الرقم الضريبي للعميل :</span> <span style="font-size: 1.2rem; font-weight: bold; ">  {{$store->Tax_Number}}</span> 
                            <br/>
                            <span style="font-size: 1.5rem; font-weight: bold; "> عنوان العميل: </span>  <span  style="font-size: 1.2rem; font-weight: bold;">  {{$store->Address}}</span>
                            <br/>
    ...
    <table cellpadding="0" cellspacing="0" class="invoice_table " style=" border: 1px solid black; height:300 px">
        ...
        <tr>
            ...
            <td style=" text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ;font-size: 1.5rem;"
                rowspan="2">{{number_format($total['Rep'], 2, '.', ',')}}</td>
            <td  style=" text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ;font-size: 1.5rem;"
                 rowspan="2">{{ number_format($vat['Rep'], 2, '.', ',')}}</td>
            <td style=" text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold; padding:3px !important;vertical-align: middle ;font-size: 1.5rem;"
                rowspan="2">{{ number_format($cost['Rep'], 2, '.', ',')}}</td>
        ...
        <tr>
            {{--    storage --}}
            <td style=" text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ;font-size: 1.5rem;"
                rowspan="2">{{number_format($total['Storage'],2, '.', ',')}}</td>
            <td style=" text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ;font-size: 1.5rem;"
                rowspan="2">{{number_format($vat['Storage'],2, '.', ',')}}</td>
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ;font-size: 1.5rem;"
                rowspan="2">{{number_format($cost['Storage'],2, '.', ',')}}</td>
        ...
        <tr>
            {{--    Handling --}}
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ;font-size: 1.5rem;"
                rowspan="2">{{number_format($total['Handling'],2, '.', ',')}}</td>
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ;font-size: 1.5rem;"
                rowspan="2">{{number_format($vat['Handling'],2, '.', ',')}}</td>
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ;font-size: 1.5rem;"
                rowspan="2">{{number_format($cost['Handling'],2, '.', ',')}}</td>
        ...
        <tr>
            {{--    Shipping --}}
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ;font-size: 1.5rem;"
                rowspan="2">{{number_format($total['Shipping'],2, '.', ',')}}</td>
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ;font-size: 1.5rem;"
                rowspan="2">{{number_format($vat['Shipping'],2, '.', ',')}}</td>
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ;font-size: 1.5rem;"
                rowspan="2">{{number_format($cost['Shipping'],2, '.', ',')}}</td>
        ...
        <tr>
            {{--    ٌReturns --}}
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold; padding:3px !important;vertical-align: middle ; font-size: 1.5rem;"
                rowspan="2">{{number_format($total['RetrunHandling'],2, '.', ',')}}</td>
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ; font-size: 1.5rem;"
                rowspan="2">{{number_format($vat['RetrunHandling'],2, '.', ',')}}</td>
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ; font-size: 1.5rem;"
                rowspan="2">{{number_format($cost['RetrunHandling'],2, '.', ',')}}</td>
        ...
        <tr>
            {{--    System charge --}}
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ; font-size: 1.5rem;"
                rowspan="2">{{$total['System']}}</td>
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ; font-size: 1.5rem;"
                rowspan="2">{{$vat['System']}}</td>
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ; font-size: 1.5rem;"
                rowspan="2">{{$cost['System']}}</td>
        ...
        <tr>
            {{--    ٌReturns --}}
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ; font-size: 1.5rem;"
                rowspan="2">{{number_format($total['Transportaion'],2, '.', ',')}}</td>
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ; font-size: 1.5rem;"
                rowspan="2">{{number_format($vat['Transportaion'],2, '.', ',')}}</td>
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ; font-size: 1.5rem;"
                rowspan="2">{{number_format($cost['Transportaion'],2, '.', ',')}}</td>
            <td style=" text-align: center; border-bottom-style:dotted; border: 1px solid black;font-weight: bold;padding:3px !important;">-------------</td>
        ...
        <tr>
            {{--    ٌReturns --}}
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ;font-size: 1.5rem;"
                rowspan="2">{{number_format($total['ExtraCost'],2, '.', ',')}}</td>
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold;padding:3px !important; vertical-align: middle ;font-size: 1.5rem;"
                rowspan="2">{{number_format($vat['ExtraCost'],2, '.', ',')}}</td>
            <td style="text-align: center; border: 1px solid ; border-bottom-color: red ; font-weight: bold; padding:3px !important;vertical-align: middle ;font-size: 1.5rem;"
                rowspan="2">{{number_format($cost['ExtraCost'],2, '.', ',')}}</td>
            <td style=" text-align: center; border-bottom-style:dotted; border: 1px solid black;font-weight: bold;padding:3px !important;">-------------</td>
        ...
        <tr>
            ...
            <td style=" text-align: center; border: 1px solid black;font-weight: bold; font-size: 1.5rem;padding:3px !important;"
                rowspan="2">{{number_format($total_total,2, '.', ',')}}</td>
            <td style=" text-align: center; border: 1px solid black;font-weight: bold; font-size: 1.5rem;padding:3px !important;"
                rowspan="2">{{number_format($total_vat,2, '.', ',')}}</td>
            <td style=" text-align: center; border: 1px solid black;font-weight: bold; font-size: 1.5rem;padding:3px !important;"
                rowspan="2">{{number_format($total_cost,2, '.', ',')}}</td>
        ...
        <tr>
            {{--    ٌReturns --}}
            <td style=" text-align: center; border: 1px solid black;font-weight: bold; font-size: 1.5rem;padding:3px !important;"
                rowspan="2">{{number_format($total['general_discount'],2, '.', ',')}}</td>
            <td style=" text-align: center; border: 1px solid black;font-weight: bold; font-size: 1.5rem;padding:3px !important;"
                rowspan="2">{{number_format($vat['general_discount'],2, '.', ',')}}</td>
            <td style=" text-align: center; border: 1px solid black;font-weight: bold; font-size: 1.5rem;padding:3px !important;"
                rowspan="2">{{number_format($cost['general_discount'],2, '.', ',')}}</td>
        ...
        <tr>
            {{--    ٌReturns --}}
            <td style=" text-align: center; border: 1px solid black;font-weight: bold; font-size: 1.5rem;padding:3px !important;"
                rowspan="2">{{number_format($due_total_total,2, '.', ',')}}</td>
            <td style=" text-align: center; border: 1px solid black;font-weight: bold; font-size: 1.5rem;padding:3px !important;"
                rowspan="2">{{number_format($due_discount,2, '.', ',')}}</td>
            <td style=" text-align: center; border: 1px solid black;font-weight: bold; font-size: 1.5rem;padding:3px !important;"
                rowspan="2">{{number_format($due_total,2, '.', ',')}}</td>
