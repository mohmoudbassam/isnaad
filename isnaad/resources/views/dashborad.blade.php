    ...
    <div class="content-body">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"> Carrier peformance</h4>
                        <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                        <div class="heading-elements">
                            <ul class="list-inline mb-0">
                                <li><a data-action="collapse"><i class="feather icon-chevron-down"></i></a></li>
...
@section('scripts')
    ...
    <script>
        ...
        var options = {
            series: [mydat.devliverd, mydat.Returned, mydat.inTransit],
            chart: {
                width: 500,
                type: 'pie',
            },
            labels: ['Deliverd', 'return', 'intransit'],
            responsive: [{
                breakpoint: 480,
                options: {
                    chart: {
...
///chart all carieres
    ...
    <script>
        ...
        $("#filter").on('click', function () {
            ...
            chart.updateSeries([  mydat.devliverd, mydat.Returned, mydat.inTransit]);
            $('#all_order').text(mydat.allCount);
...
//re render chart cod
            ...
            $.when($.ajax({
                ...
                success: function (data) {
                    mydat = data;
                    chart2.updateSeries([ mydat.devliverd, mydat.Returned, mydat.inTransit]);
                    $('#all_cod').text(mydat.allCount);
                }
            }));
