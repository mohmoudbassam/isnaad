            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-2 mb-lg-0 mb-6">
                    ...
                    <select class="form-control datatable-input" id="platform" data-col-index="6">
                        ...
                        <option value="3">otherttttt</option>
                    </select>
                </div>
                  <div class="col-lg-2 mb-lg-0 mb-6">
                    <label>place:</label>
...
@section('scripts')
            ...
            var initTable1 = function () {
                ...
                table.DataTable({
                    ...
                    columns: [
                        ...
                        { "data": 'carriers.tracking_link', name:"tracking_number","render": function (data, type, row, meta) {
                        ...
                        @endcan
                            @can('isnaarReport_shippingPrice')
                        { data: 'shipping_price', "render": function (data, type, row, meta) {
                              try {
  ...
  console.log(error,data);
                    ...
                    "footerCallback": function(row, data, start, end, display) {
                        ...
                        if(data[0]){
                            if(data[0].cod_total){
                                $('#kt_datatable').append($('<tfoot class="removal">').append( 'tr>' + '<th colspan="11" style="text-align:right">Total:</th>'+'<th>'+data[0].cod_total+'</th>'+'</tr>') );
