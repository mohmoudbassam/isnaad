    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                ...
                <h3 class="card-label">Client Return</h3>
            </div>
        ...
        <div class="card-body">
            <div class="row mb-6">
                ...
                <div class="col-lg-2 mb-lg-0 mb-6">
                    <label>Carrier:</label>
                    <select class="form-control datatable-input" name="carierrs" id="carierrs" data-col-index="2">
                ...
                <div class="col-lg-2 mb-lg-0 mb-6">
                    ...
                    <select class="form-control datatable-input" name="date_type" id="date_type" data-col-index="2">

                        <option value="created_at">shipping date</option>
                        <option value="delivred_date">delivred date</option>

                    </select>
                </div>
                <div class="col-lg-1 mb-lg-0 mb-6">
                    <label>Status:</label>
                    <select class="form-control datatable-input" name="status" id="status" data-col-index="2">
                        <option value="">select </option>
                ...
                <div class="col-lg-2 mb-lg-0 mb-6">
                    <label>place:</label>
                    <select class="form-control datatable-input" name="place" id="place" data-col-index="2">
                        <option value="">select </option>
...
@section('scripts')
    ...
    <script>
            ...
            var initTable1 = function () {
                ...
                table.DataTable({
                    ...
                    columns:   [
                        ...
                        {data: 'delivred_date', name: 'delivred_date'},
                        {data: 'carrier.name', name: 'carrier', searchable: false},
                        {data: 'shipping_number', name: 'shipping_number'},

                        { "data": 'traking_number', "render": function (data, type, row, meta) {

                                data = '<a href="'+row.carrier.tracking_link+data  + '" target="_blank">'+data+'</a>';
                                return data;
                            }},
                        {data: 'inv', name: 'inv'},
                        {data: 'cost', name: 'cost'},
        ...
        $('#btn-excel').click(function () {
            ...
            var url = "{{URL::to('export-return-date')}}?" + $.param(query);
