...
@section('content')
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                ...
                <h3 class="card-label">Statments</h3>
            </div>
                ...
                <div class="dropdown dropdown-inline mr-2">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                        ...
                        <ul class="navi flex-column navi-hover py-2">
                            ...
                            <li class="navi-item">
                                <a href="{{route('add-statmet-ne')}}" class="navi-link">
																<span class="navi-icon">
																	<i class="far fa-plus-square"></i>
																</span>
                                    <span class="navi-text">add billing</span>
                                </a>
                            </li>
                            <li class="navi-item">
                            ...
                            <li class="navi-item">
                                <a href="#" class="navi-link" id="make-paid">
																<span class="navi-icon">
																	<i class="fas fa-dollar-sign"></i>
																</span>
                                    <span class="navi-text">Make Paid</span>
                                </a>
                            </li>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-3 mb-lg-0 mb-6">
                    ...
                    <div class="input-daterange input-group" id="kt_datepicker">
                        ...
                        <select class="form-control datatable-input" name="paid" id="paid">
                            <option value="">select</option>
                ...
                <div class="row mb-6">
                    <div class="col-lg-3 mb-lg-0 mb-6">
                        ...
                        <div class="input-daterange input-group" id="kt_datepicker">
                            ...
                            <input type="text" class="form-control datatable-input" id="to_amount"
                                   placeholder="To"
                                   data-col-index="5">
                        </div>
                    </div>
    ...
    {{--  this is the modal for make paid   --}}
    <div class="modal fade" id="makePaidModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <div class="modal-dialog" id="blocked" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure to make the invoice paid ?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">Close
                    </button>
                    <button type="button" class="btn btn-primary font-weight-bold" onclick="makePaidRequest()">Save
                        changes
                    </button>
                </div>
            </div>
            ...
            var initTable1 = function () {
                ...
                table.DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            data: 'inv', render: function (data, type, row, meta) {
                                return '<a href="{{URL::to('ne-show-statment/')}}' + "/" + row.id + '">' + data + '</a>'
                            }
                        },
                        ...
                        {data: 'description_to_date', name: 'description_to_date'},
                        {
                        ...
                        {
                            data: 'net_balance', render: function (data, type, row, meta) {
                       ...
                       @can('Billing_delete')
                        {
                            data: 'id', render: function (data, type, row, meta) {
                                ...
                                return '<a href="#" onclick="delete_statment(' + row.id + '' + "," + '' + data + ')" ><i class="far fa-trash-alt" style="font-size:30px;color:red"></i></a>';
                            }, "searchable": false,
                        }
                        @endcan
                    ],
                    "footerCallback": function (row, data, start, end, display) {
                        ...
                        $('.removal').remove()
                        $('#kt_datatable').append($('<tfoot class="removal">').append('tr>' + '<th colspan="7" style="text-align:right">Total:</th>' + '<th>' + isnaadInvoice + '</th>' + '<th>' + total_cod + '</th>' + '<th>' + netBlance + '</th>' + '</tr>'));
...
//console.log( $('#statment_from_date').val())
    ...
    <script>
        $('#make-paid').on('click', function () {
            if ($('.select:checkbox:checked').length == 0) {
                ...
                toastr.warning("pleas select statment");
            } else {
                openMakePaidModal();
            }
        });

        function openMakePaidModal() {
            $('#makePaidModal').modal('show');
        }

        function makePaidRequest() {


            let data = $('.select:checkbox:checked').map(function () {
                return $(this).val();
            }).get();
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == true) {
                        ...
                        toastr.success("statment updated successfully");
