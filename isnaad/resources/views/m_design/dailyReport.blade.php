...
@section('content')
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-dark">Total Orders</span>
    ...
    <div class="card card-custom gutter-b">
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label">Orders per clients</h3>
            </div>
        </div>
        <div class="card-body">
        ...
        $.ajax({
            ...
            success: function (response) {
              ...
              //  console.log(response.sh_order)
                createStoreChart(response.sh_order);
                KTApp.unblockPage();
...
<script>
    ...
    function makedayTbale(stores){
      ...
      //  let i=0;
        ...
        totalLeadTime=(totalLeadTime/stores.length).toFixed(2)+' M'
        tr+='<tr class="removal">'+'<td>'+'Grand total'+'</td>'+'<td>'+totalOrder+'</td>'+'<td>'+totaQty+'</td>'+'<td>'+'</td>'+'<td>'+totalLeadTime+'</td>'+'</tr>'
        return tr;
    }
</script>
    <script>
    ...
    <script>
        function createStoreChart(order){
...
// Add and configure Series
                ...
                pieSeries.dataFields.value = "order_number";
