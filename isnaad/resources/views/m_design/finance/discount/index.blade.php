    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                ...
                <h3 class="card-label">Add & Discount Invoicise</h3>
            </div>
        ...
        var KTDatatablesDataSourceAjaxServer = function () {
            ...
            var initTable1 = function () {
                ...
                table.DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: '{!! route('finance.discountsList') !!}',
                        type: 'GET',
                        data: function (d) {
                    ...
                    columns: [
                        ...
                        { data: 'date', name: 'date' },
                        { data: 'service_type_ser', name: 'service_type_ser' },
                        { data: 'total_item', name: 'total_item' },
                        { data: 'cost', name: 'cost' },
                        { data: 'total_disccount', name: 'total_disccount' },
