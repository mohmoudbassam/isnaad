    ...
    <div class="card card-custom">
        <div class="card-header">
            <div class="card-title">
                ...
                <h3 class="card-label">Draft Invoice</h3>
            </div>
        ...
        var KTDatatablesDataSourceAjaxServer = function () {
            ...
            var initTable1 = function () {
                ...
                table.DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: '{!! route('finance.draft-invoice-list') !!}',
                        type: 'GET',
                        data: function (d) {
...
//alert($('#dateType').val());
                ...
                if (result.value) {
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.success) {
                                $('#draft-invoice').DataTable().ajax.reload(null, false);
        ...
        function confirmInv(id){
            $.ajax({
                url: '{{route('invoice-con')}}',
                type: "POST",
                data: {
                    "_token": "{{ csrf_token() }}",
                    'id': id
                ...
                success: function (data) {
                    if (data.success) {
                        ...
                        $('#draft-invoice').DataTable().ajax.reload(null, false);
                        showAlertMessage('success', 'invoice confirmed successfully');
                    } else {
                  showAlertMessage('error', 'unknown error');
                    }
                    KTApp.unblockPage();
