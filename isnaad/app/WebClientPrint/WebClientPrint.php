...
class PrintFile{
     ...
     */
    public function __construct($filePath, $fileName, $fileBinaryContent ,$flag=true) {
...
class ClientPrintJob{
    ...
    public function sendToClient(){
        ...
        if (!Utils::isNullOrEmptyString($this->printerCommands)){
            ...
            $buffer = 'wcpPFG:';
            $zip = new ZipArchive;
            $cacheFileName =  app_path('WebClientPrint/').(Utils::strEndsWith(WebClientPrint::$wcpCacheFolder, '/')?WebClientPrint::$wcpCacheFolder:WebClientPrint::$wcpCacheFolder.'/').'PFG'.uniqid().'.zip';
