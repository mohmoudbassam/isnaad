...
class Sign_cron extends Command
{
	use Salla_helper;
    /**
     ...
     * @var string
     */
    protected $description = 'this crone job for Sign perfumes update status';
    ...
    {
       Log::error('Sign perfumes cron job');

      $orders = order::where([['store_id', '55'], ['processing_status', '0'], ['active', '1']])
