...
class Sukkari_cron extends Command
{
	use Salla_helper;
    /**
     ...
     * @var string
     */
    protected $signature = 'Sukkari:cron';
     ...
     * @var string
     */
    protected $description = 'this crone job for Sukkari update status';
    ...
    {
       Log::error('Sukkari cron job');

      $orders = order::where([['store_id', '53'], ['processing_status', '0'], ['active', '1']])
