...
class wareedmedical_cron extends Command
{
	use Salla_helper;
    /**
     ...
     * @var string
     */
    protected $signature = 'wareedmedical:cron';
     ...
     * @var string
     */
    protected $description = 'this crone job for wareedmedical update status';
    ...
    {
       Log::error('wareedmedical cron job');
