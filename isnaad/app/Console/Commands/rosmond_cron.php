...
class rosmond_cron extends Command
{
	use Salla_helper;
    /**
     ...
     * @var string
     */
    protected $signature = 'rosmond:cron';
     ...
     * @var string
     */
    protected $description = 'this crone job for rosmond update status';
