...
class Scarf_cron extends Command
{
	use Salla_helper;
    /**
     ...
     * @var string
     */
    protected $signature = 'Scarf:cron';
     ...
     * @var string
     */
    protected $description = 'this crone job for Scarf update status';
    ...
    {
       Log::error('Scarf cron job');

      $orders = order::where([['store_id', '64'], ['processing_status', '0'], ['active', '1']])
