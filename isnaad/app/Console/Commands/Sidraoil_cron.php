...
class Sidraoil_cron extends Command
{
	use Salla_helper;
    /**
     ...
     * @var string
     */
    protected $signature = 'sidra_oil:cron';
     ...
     * @var string
     */
    protected $description = 'this crone job for sidra_oil update status';
