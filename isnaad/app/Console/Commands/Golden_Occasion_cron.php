...
class Golden_Occasion_cron extends Command
{
	use Salla_helper;
    /**
     ...
     * @var string
     */
    protected $signature = 'Golden_Occasion:cron';
     ...
     * @var string
     */
    protected $description = 'this crone job for Golden_Occasion update status';
    ...
    {
       Log::error('Golden_Occasion cron job');
