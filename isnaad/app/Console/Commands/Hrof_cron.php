...
class Hrof_cron extends Command
{
	use Salla_helper;
    /**
     ...
     * @var string
     */
    protected $description = 'this crone job for Hrof perfumes update status';
    ...
    {
       Log::error('Hrof perfumes cron job');

      $orders = order::where([['store_id', '61'], ['processing_status', '0'], ['active', '1']])
