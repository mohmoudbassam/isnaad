...
class Seenglasses_cron extends Command
{
	use Salla_helper;
    /**
     ...
     * @var string
     */
    protected $signature = 'Seenglasses:cron';
     ...
     * @var string
     */
    protected $description = 'this crone job for Seenglasses update status';
    ...
    {
       Log::error('Seenglasses cron job');

      $orders = order::where([['store_id', '56'], ['processing_status', '0'], ['active', '1']])
