...
class wixana_cron extends Command
{
	use Salla_helper;
    /**
     ...
     * @var string
     */
    protected $signature = 'wixana:cron';
     ...
     * @var string
     */
    protected $description = 'this crone job for wixana update status';
            ...
            if ($order->order_status == 'inTransit') {
                ...
                if ($order->in_transit != null) {
                    ...
                    if ($statusCode == 200) {
                        ...
                        Log::error('suc wixana orNum inTransit' . $order->order_number);
                    }
                }
                ...
                if ($statusCode == 200) {
                    ...
                    Log::error('suc wixana orNum Delivered' . $order->order_number);
                    }else{
                    Log::error('suc wixana orNum Returned' . $order->order_number);
                    }
